...
namespace Donor_System
{
    public class EmailService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            email.IsBodyHtml = true; // Set to true if the body contains HTML
            ...
            smtpClient.Credentials = new NetworkCredential("BloodDonorAC@outlook.com", "GroupAC@2023");
            smtpClient.EnableSsl = true;

            try
            {
                smtpClient.Send(email); // Send the email
            }
            catch (Exception ex)
            {
            ...
            {
                email.Dispose(); // Dispose of the email object
            }
