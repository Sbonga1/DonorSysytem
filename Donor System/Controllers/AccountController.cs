            ...
            if (ModelState.IsValid)
            {
                if(model.Role == "ExternalDoctor")
                {
                    ...
                    try
                    {
                        ...
                        var dr = new ExternalDrReg();
                        dr.Name = name;
                        dr.Email = email;
                        dr.Status = "Awaiting Approval";
                        dr.Surname = surname;
                        if (file != null && file.ContentLength > 0)
                        {
                            ...
                            dr.FileContent = pdfData;
                        }
                        db.ExternalDrRegs.Add(dr);
                        db.SaveChanges();
                    ...
                    {
                        TempData["DrRegError"] = "Something went wrong, Please try again later.";
                    }
